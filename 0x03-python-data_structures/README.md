...
-   GitHub repository: `alx-higher_level_programming`
-   Directory: `0x02-python-import_modules`
-   File: `5-variable_load.py`0x03. Python - Data Structures: Lists, Tuples
=============================================

-   By Guillaume
-   Weight: 1
-   Ongoing project - started 11-19-2021, must end by 11-23-2021 (in 3 days) - you're done with 0% of tasks.
-   Checker will be released at 11-21-2021 06:00 AM
-   QA review fully automated.
